...
function About () {
    return(
        <div>
            <h1>Easy Recipes That You'll Love!</h1>
            <img src={povar2} alt=""/>
            <h5> Welcome to our recipe website! Here you will find a variety of diverse and delicious dishes that you can easily cook at home. We invite you to plunge into the world of culinary art and learn how to create real masterpieces from ordinary products. Here you'll find delicious, trusted recipes with easy step-by-step photos and videos. <br/>
            ...
            Cook with us and enjoy delicious and varied dishes! </h5>
